						...
						<div class="row">
							<div class="col-xs-12">
								<ul id="demo2">
									...
									<li class="news-item">Sania Nehwal becomes Badminton no.1 <a href="#">Read more...</a></li>
									<li class="news-item">Result of badminton matches held last month <a href="#">Read more...</a></li>
									<li class="news-item">Result of cricket matches held last month <a href="#">Read more...</a></li>
								</ul>
							</div>
						</div>
					</div>
